...
export default async function handler(
  _: NextApiRequest,
  res: NextApiResponse<Response<City[]>>,
) {
  try {
    const url = new URL("https://api.rajaongkir.com/starter/city")
    ...
    const data: RajaOngkirResponse<City[]> = await response.json()
...
// const data: RajaOngkirResponse<City[]> = {
//   rajaongkir: {
//     results: [
//       {
//         city_id: "1",
